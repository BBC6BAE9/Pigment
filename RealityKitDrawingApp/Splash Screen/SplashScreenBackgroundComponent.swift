...
struct SplashScreenBackgroundComponent: TransientComponent {
    ...
    @MainActor private var textureSize: SIMD2<Int> {
    ...
    @MainActor private static func generateTexture(width: Int, height: Int) throws -> LowLevelTexture {
    ...
    @MainActor mutating func setTextureSize(_ textureSize: SIMD2<Int>) throws {
        lowLevelTexture = try Self.generateTexture(width: textureSize.x, height: textureSize.y)
